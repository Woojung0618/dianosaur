...
var AirPlane = function () {
  ...
  // 꼬리
  var geomCabin = new THREE.BoxGeometry(140, 50, 50, 1, 1, 1);
  ...
  var geomEngine = new THREE.BoxGeometry(60, 60, 60, 60, 60, 60);
  ...
  //상체
  var geomEngine = new THREE.BoxGeometry(30, 80, 80, 40, 40, 40);
  var matEngine = new THREE.MeshPhongMaterial({
    color: Colors.darkdarkgreen,
    shading: THREE.FlatShading,
  });
  var engine1 = new THREE.Mesh(geomEngine, matEngine);
  engine1.position.x = 60;
  engine1.position.y = 30;
  ...
  var head = new THREE.BoxGeometry(100, 50, 50, 1, 1, 1);
  var matCabin = new THREE.MeshPhongMaterial({
    color: Colors.darkgreen,
    shading: THREE.FlatShading,
  });

  head.vertices[7].y -= 10;
  head.vertices[7].z += 10;

  head.vertices[6].y -= 10;
  head.vertices[6].z -= 20;

  head.vertices[5].y += 10;
  head.vertices[5].z += 10;

  head.vertices[4].y += 20;
  head.vertices[4].z -= 20;

  var cabin2 = new THREE.Mesh(head, matCabin);

  cabin2.position.x = 100;
  cabin2.position.y = 100;
  ...
  //눈
  var eye = new THREE.BoxGeometry(50, 5, 30, 1, 1, 1);
  var matCabin = new THREE.MeshPhongMaterial({
    color: Colors.white,
    shading: THREE.FlatShading,
  });
  ...
  var cabin3 = new THREE.Mesh(eye, matCabin);

  cabin3.position.x = 100;
  cabin3.position.y = 100;

  cabin3.castShadow = true;

  cabin3.receiveShadow = true;
  this.mesh.add(cabin3);

  //눈동자

  var eye0 = new THREE.BoxGeometry(50, 5, 50, 1, 1, 1);
  var matCabin = new THREE.MeshPhongMaterial({
    color: Colors.brownDark,
    shading: THREE.FlatShading,
  });
  eye0.vertices[7].x += 10;
  eye0.vertices[7].y -= 10;
  eye0.vertices[7].z += 10;

  eye0.vertices[6].x += 20;
  eye0.vertices[6].y -= 10;
  eye0.vertices[6].z -= 30;

  eye0.vertices[5].x += 20;
  eye0.vertices[5].y += 5;
  eye0.vertices[5].z += 30;

  eye0.vertices[4].x -= 20;
  eye0.vertices[4].y += 5;
  eye0.vertices[4].z -= 30;

  var cabin4 = new THREE.Mesh(eye0, matCabin);

  cabin4.position.x = 100;
  cabin4.position.y = 100;

  cabin4.castShadow = true;

  cabin4.receiveShadow = true;
  this.mesh.add(cabin4);

  // Tail Plane

  var geomTailPlane = new THREE.BoxGeometry(15, 20, 5, 1, 1, 1);
  var geomTailPlane2 = new THREE.BoxGeometry(15, 10, 5, 1, 1, 1);
  var geomTailPlane3 = new THREE.BoxGeometry(15, 5, 5, 1, 1, 1);
  var matTailPlane = new THREE.MeshPhongMaterial({
    color: Colors.red,
    shading: THREE.FlatShading,
  });
  var tailPlane1 = new THREE.Mesh(geomTailPlane, matTailPlane);
  tailPlane1.position.set(0, 20, 0);
  tailPlane1.castShadow = true;
  tailPlane1.receiveShadow = true;

  var tailPlane2 = new THREE.Mesh(geomTailPlane2, matTailPlane);
  tailPlane2.position.set(-20, 20, 0);
  tailPlane2.castShadow = true;
  tailPlane2.receiveShadow = true;

  var tailPlane3 = new THREE.Mesh(geomTailPlane3, matTailPlane);
  tailPlane3.position.set(-40, 20, 0);
  tailPlane3.castShadow = true;
  tailPlane3.receiveShadow = true;

  this.mesh.add(tailPlane1);
  this.mesh.add(tailPlane2);
  this.mesh.add(tailPlane3);
  ...
  wheelProtecR.position.set(30, -60, 25);
  ...
  var geomPropeller2 = new THREE.BoxGeometry(-20, -100, 100, 1, 1, 1);
  //var geomPropeller2 = new THREE.BoxGeometry(0, 0, 0, 1, 1, 1);
  ...
  var wheelAxisGeom = new THREE.BoxGeometry(20, 90, 15);
  ...
  var wheelTireR = new THREE.Mesh(wheelAxisGeom, wheelAxisMat);
  wheelTireR.position.set(30, -10, 20);
  ...
  var wheelTireBL = wheelTireL.clone();
  wheelTireBL.position.y = wheelTireL.position.y - 80;

  this.pilot = new Pilot();
  this.pilot.mesh.position.set(20, 50, 0);
